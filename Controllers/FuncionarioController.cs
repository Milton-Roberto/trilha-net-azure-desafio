...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        _context.SaveChanges(); // Salva a nova entrada no banco SQL
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        tableClient.UpsertEntity(funcionarioLog); // Atualiza no Azure Table
    ...
    public IActionResult Deletar(int id)
    {
        ...
        tableClient.UpsertEntity(funcionarioLog); // Registra a remoção no Azure Table
        return NoContent();
    }
}
